...
(
    "AlbumId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
...
(
    "ArtistId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
    "Name" NVARCHAR(120)
);

CREATE TABLE "dbo"."Customer"
(
    "CustomerId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
...
(
    "EmployeeId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
    "LastName" NVARCHAR(20) NOT NULL,
...
(
    "GenreId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
    "Name" NVARCHAR(120)
);

CREATE TABLE "dbo"."Invoice"
(
    "InvoiceId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
...
(
    "InvoiceLineId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
...
(
    "MediaTypeId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
    "Name" NVARCHAR(120)
);

CREATE TABLE "dbo"."Playlist"
(
    "PlaylistId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
    "Name" NVARCHAR(120)
);
...
(
    "TrackId" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1),
