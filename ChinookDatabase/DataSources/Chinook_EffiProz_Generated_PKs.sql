...
(
    "AlbumId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
...
(
    "ArtistId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
    "Name" NVARCHAR(120)
);
\
CREATE TABLE "Chinook"."Customer"
(
    "CustomerId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
...
(
    "EmployeeId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
    "LastName" NVARCHAR(20)  NOT NULL,
...
(
    "GenreId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
    "Name" NVARCHAR(120)
);
\
CREATE TABLE "Chinook"."Invoice"
(
    "InvoiceId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
...
(
    "InvoiceLineId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
...
(
    "MediaTypeId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
    "Name" NVARCHAR(120)
);
\
CREATE TABLE "Chinook"."Playlist"
(
    "PlaylistId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
    "Name" NVARCHAR(120)
);
\
...
(
    "TrackId" INT GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 START WITH 1) NOT NULL,
