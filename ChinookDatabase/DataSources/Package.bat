...
"C:\Program Files\7-Zip\7z.exe" a %rootDir%\Packages\ChinookDatabase1.4_PostgreSql.zip Chinook_PostgreSql.sql Chinook_PostgreSql_CaseInsensitive.sql Chinook_PostgreSql_SerialPKs.sql Chinook_PostgreSql_CaseInsensitive_SerialPKs.sql CreatePostgreSql.bat
