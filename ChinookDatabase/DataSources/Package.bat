...
"C:\Program Files\7-Zip\7z.exe" a %rootDir%\Packages\ChinookDatabase1.4.3_PostgreSql.zip Chinook_PostgreSql.sql Chinook_PostgreSql_AutoIncrementPKs.sql Chinook_PostgreSql_SerialPKs.sql CreatePostgreSql.bat
